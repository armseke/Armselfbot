...
cl = LINETCR.LINE()
cl.login(token='EoHM5VXLHOCKDPVcjpG4.vbU6UHxwJZPLiqAG3LO/La.3FY067ftzU8lYzVqRNNfdbA4BL3mU13S5JFZeNRs1FI=')
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token='EoV6CGOjghbd0Jc9apa8.TTWtYUlQrcUxwXvRT+2Goa.062SzBWE7cW+GRwiGfKgwcKmT2UOLyEvRhxVLQ7+t5g=')
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token='Eo0awotCS1DxidJJZMB8.bkgPpxXPrPAZRLDEoxNDYa.wnML76Wgtc91xBREo7S3tFg5rQbaYS5l0PPMf45wm9I=')
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token='EomqLp0MiepYmQlIR9Jd.F/CVmVWfcZnxJlQCR7VPNq.qGxujbNyYlHkRpUOfF4SnqyqjXopINx3SkczjI8Hpt4=')
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token='Eo3NYmAMvcxsuk94CLC5.Trbb5xpI9SaHEWMh3DRAjq.2Xi9PRMyUCUng/2/CZXGcLGVa2o8rh67gT3boLneHCc=')
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token='EoVKfTgoRnyJ69IVa0o1.rwuMFxBZUtI0U51sC+wC8q.OTL3dub16EnawrPyggk+ItVin3lCQANO0Qfg3pZE/ME=')
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token='Eo5BYwZEVZgnbzsrW4ra.KoXHmHiOzOkqtH1XV2hNkG.wIMlXQj6tqRwr9Q+JzAY1twVtyrIARd2ne7qzvqmkRc=')
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token='EobkXq7r4jTp1A8PGwn5.P+TKw/uQ9eN6HLyqdtWbTq.TgwGVwjRD9IS7UGQxAEnoMtpWCHxBM6mLX94RXqM6w4=')
ki7.loginResult()
...
KAC=[ki1,ki2,ki3,ki4,ki5,ki6,ki7]
...
targets = []
mid = cl.getProfile().mid
Bots = ["u541bbaba15d68f3a652106a0de5a3e94",mid,Amid1,Amid2,Amid3,Amid4]
self = ["u541bbaba15d68f3a652106a0de5a3e94",mid,Amid1,Amid2,Amid3,Amid4]
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    pass
                                cl.sendText(op.param1,"ผู้ใช้นี้ได้ทำการเปลี่ยนชื่อกลุ่ม (｀・ω・´)")
                ...
                if msg.from_ == mid:
                    if "join:" in msg.text:
                        ...
                        try:
                            ...
                            cl.sendText(msg.to,"เกิดข้อผิดผลาด (｀・ω・´)")
            if msg.toType == 1:
                if wait["leaveRoom"] == True:
                    cl.leaveRoom(msg.to)
        ...
        if op.type == 26:
                    ...
                    if msg.text is not None:
                        ...
                        if data['status'] == 200:
                            if data['result']['result'] == 100:
                                ki4.sendText(msg.to, "[ BOT ] " + data['result']['response'].encode('utf-8'))

            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["คิดถึงหรอ ?" + cName + "ถึงได้แท็กเยอะขนาดนี้", cName + "แท็กขนาดนี้ทักแชทมาบ้างก็ได้นะ", "= w =", "(｀・ω・´)", cName + "คิดถึงเราหรอ ? เราก็คิดถึงเหมือนกันนะ", "อย่าแท็กกู กูไม่ว่าง!!", cName + " มีปัญหาอะไร ?!", "ยังๆ ยังไม่หยุด", "ขอร้องเหอะตีป้อมอยู่!!", cName + " ทำไมต้องแท็ก?" + cName, "ชอบแท็กนักหราา " + cName, "ขาดความอบอุ่นหราาา ", "== ww =="]
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     ...
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["เตะแม่มขอหาแท็กไม่หยุด (｀・ω・´) "]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        cl.sendText(msg.to,"แสดงคิดเห็นแล้ว (｀・ω・´)")
                        wait["wblack"] = False
                    else:
                        wait["commentBlack"][msg.contentMetadata["mid"]] = True
                        wait["wblack"] = False
                        cl.sendText(msg.to,"ตัดสินใจที่จะไม่แสดงความคิดเห็น (｀・ω・´)")

               elif wait["dblack"] == True:
                   if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        del wait["commentBlack"][msg.contentMetadata["mid"]]
                        cl.sendText(msg.to,"ลบเรียบร้อยแล้ว (｀・ω・´)")
                        
                        wait["dblack"] = False

                   else:
                        wait["dblack"] = False
                        cl.sendText(msg.to,"ผู้ใช้นี้ไม่ได้อยู่ในบัญชีดำ (｀・ω・´)")
                        
               elif wait["wblacklist"] == True:
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        cl.sendText(msg.to,"เพิ่มผู้ใช้นี้เข้าบัญชีดำเรียบร้อยแล้ว (｀・ω・´)")

                        wait["wblacklist"] = False
                   else:
                        wait["blacklist"][msg.contentMetadata["mid"]] = True
                        wait["wblacklist"] = False
                        cl.sendText(msg.to,"ผู้ใช้นี้อยู่ในบัญชีดำอยู่แล้ว (｀・ω・´)")
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                if wait['binvite'] == True:
                    ...
                    for s in groups.members:
                        if _name in s.displayName:
                            ki2.sendText(msg.to,"❂͜͡☆➣ " + _name + " อยู่ในกลุ่มนี้แล้ว")
                        else:
                            targets.append(invite)
                    if targets == []:
                        pass
                        ...
                        for target in targets:
                            try:
                                ...
                                ki2.sendText(msg.to,"เชิญเสร็จแล้ว : \n❂͜͡☆➣ " + _name)
                                wait['binvite'] = False
                                break                              
                            except:             
                                    ki2.sendText(msg.to,"​​ตรวจพบข้อผิดพลาด")
                                    wait['binvite'] = False
                                    break
                ...
                if spl[0] == "":
                    try:
                        cl.sendText(msg.to,subprocess.check_output(spl[1],shell=True,cwd=r"../"))
                    except:
                        pass
                ...
                if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            f=codecs.open('st2__b.json','w','utf-8')
                            json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                            cl.sendText(msg.to,"แบนผู้ใช้นี้เรียบร้อยแล้ว (｀・ω・´)")
                            print "[ @ ]    Bannad"
                        except:
                            pass
                ...
                if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            f=codecs.open('st2__b.json','w','utf-8')
                            json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                            cl.sendText(msg.to,"ปลดแบนผู้ใช้นี้เรียบร้อยแล้ว (｀・ω・´)")
                            print "[ @ ]    Unbannad"
                        except:
                            pass
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
            elif msg.text.lower() == 'ดีครับทุกคน':
                        ...
                        ki1.sendText(msg.to,"" + str(ginfo.name) + "\n\n[ SATAN TEST BOT]")
                        ki2.sendText(msg.to,"อย่าทะลึ่งมาเตะกูละ")
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        ki1.updateGroup(G)
            ...
            elif msg.text.lower() == 'TEAM TEST BOT':
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = False
                        cl.updateGroup(G)
            ...
            elif msg.text.lower() == 'satantestbot@login':
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = False
                        cl.updateGroup(G)
...
#==================================================
                ...
                if msg.from_ in admin:
                 wait["winvite"] = False
                 cl.sendText(msg.to,"ปิดการเชิญเรียบร้อยแล้ว")
...
""")
                ...
                if msg.to in wait['pname']:
                    cl.sendText(msg.to,"เสร็จสื้น (｀・ω・´)")
                else:
                    cl.sendText(msg.to,"เสร็จสื้น (｀・ω・´)")
                ...
                if msg.to in wait['pname']:
                    cl.sendText(msg.to,"เสร็จสิ้น (｀・ω・´)")
                    del wait['pname'][msg.to]
                else:
                    cl.sendText(msg.to,"เสร็จสิ้น (｀・ω・´)")			
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on Bosqu (｀・ω・´)")
                    else:
                        cl.sendText(msg.to,"Ok Bosqu (｀・ω・´)")
                else:
                    wait["contact"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on Bosqu (｀・ω・´)")
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah off Bosqu (｀・ω・´)")
                    else:
                        cl.sendText(msg.to,"Ok Bosqu (｀・ω・´)")
                else:
                    wait["contact"] = False
...
#===============================================
                ...
                if spl[0] == "":
                    ...
                    cl.sendMessage(msg)
#===============================================
            elif "Getprof " in msg.text.lower():
                if msg.toType == 2:
                    ...
                    for targ in gmem:
                        if targ.displayName in namel:
                            ...
                            try:
                                ...
                                pass
            elif "Gethome " in msg.text.lower():
                if msg.toType == 2:
...
#===============================================
                ...
                cl.sendText(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]")
                ...
                time.sleep(0.001)
                elapsed_time = time.time() - start
                ki1.sendText(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]")    
                ki2.sendText(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]")
                ki3.sendText(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]")
                ki4.sendText(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]")
                ki5.sendText(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]")
                ki6.sendText(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]")
                ki7.sendText(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]")              
...
#========================================
                ...
                if msg.toType == 2:
                    ...
                    ki1.sendText(msg.to, "Angle...")
                    ki1.sendText(msg.to, "With...")
                    ki1.sendText(msg.to, "A...")
                    ki1.sendText(msg.to, "ShotGun...")
                    targets = []
                    for g in gs.members:
...
#==============================================================================#
                ...
                try:
                    ...
                    data = json.loads(data)
                    for song in data:
                        hasil = 'นี่คือเพลงของคุณต้องการ (｀・ω・´)\n'
                        hasil += 'Judul : ' + song[0]
                        hasil += '\nระยะเวลา : ' + song[1]
                        hasil += '\nดาวน์โหลดลิงก์ : ' + song[4]
                        cl.sendText(msg.to, hasil)
                        cl.sendText(msg.to, "โปรดรอให้เพลง (｀・ω・´)")
        ...
        if op.type == 25:
            ...
            if msg.text.lower() in ["@@TagAll"]:
                ...
                if jml > 400 and jml < 500:
                    ...
                    mention(msg.to, nm5)
                if jml > 500:
                    cl.sendText(msg.to,'สมาชิกเกินขีดจำกัด (｀・ω・´)')
                cnt = Message()
